...
import { createInstanceSchema, updateInstanceSchema } from '../../validators/instances.validators';
...
instanceRouter.get('/services', requirePermission('services.view'), ServicesController.list);
...
instanceRouter.post('/uploads/presign', requirePermission('website.edit'), MediaController.presign);
instanceRouter.post('/uploads/local', requirePermission('website.edit'), MediaController.localUpload);
