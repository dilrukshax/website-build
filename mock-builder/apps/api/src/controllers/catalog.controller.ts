...
export class CatalogController {
    ...
    static async createTheme(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const { featureId, name, slug, version, componentKey, schemaJsonb, defaultStylesJsonb, previewImageUrl } = req.body;
    ...
    static async updateTheme(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const id = req.params.id!;
            const { name, componentKey, schemaJsonb, defaultStylesJsonb, previewImageUrl, isActive } = req.body;
