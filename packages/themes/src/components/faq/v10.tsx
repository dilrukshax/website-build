...
export default function FAQV10({ content, tokens }: ThemeComponentProps) {
    ...
    <div style={{ maxWidth: '1080px', margin: '0 auto', display: 'grid', gap: '12px', gridTemplateColumns: '1fr 1fr' }}>
