...
export default function ContactV8({ content, tokens, context }: ThemeComponentProps) {
    ...
    <div style={{ maxWidth: '1080px', margin: '0 auto', display: 'grid', gap: '10px', gridTemplateColumns: '1fr 1fr' }}>
        <article style={{ border, borderRadius: '12px', padding: '12px', background: card }}><h2 style={{ margin: 0, color: titleColor }}>{title}</h2><p style={{ margin: '8px 0 0 0', color: muted }}>{subtitle}</p></article>
        {formBlock}
    </div>
