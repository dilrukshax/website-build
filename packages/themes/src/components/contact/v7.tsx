...
export default function ContactV7({ content, tokens, context }: ThemeComponentProps) {
    ...
    <div style={{ maxWidth: '1060px', margin: '0 auto', border, background: card, borderRadius: '16px', padding: '14px' }}>
