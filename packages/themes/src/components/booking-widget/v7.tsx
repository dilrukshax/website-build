...
export default function BookingWidgetV7({ content, tokens, context }: ThemeComponentProps) {
    ...
    <div style={{ maxWidth: '980px', margin: '0 auto', border, background: card, borderRadius: '16px', padding: '14px' }}>
