...
export default function BookingWidgetV10({ content, tokens, context }: ThemeComponentProps) {
    ...
    <div style={{ maxWidth: '1080px', margin: '0 auto', display: 'grid', gap: '10px', gridTemplateColumns: '1fr 1fr' }}>
        <article style={{ border, background: card, borderRadius: '14px', padding: '12px' }}>
