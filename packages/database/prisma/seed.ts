...
// ============================================================
// Themes (catalog with versioned variants)
// ============================================================

const BOOKING_WIDGET_SCHEMA = {
    type: 'object',
    properties: {
        title: { type: 'string', title: 'Section Title' },
        subtitle: { type: 'string', title: 'Subtitle' },
        ctaText: { type: 'string', title: 'Book Button Text' },
        helperText: { type: 'string', title: 'Helper Text', format: 'textarea' },
        highlightTitle: { type: 'string', title: 'Highlights Title' },
        highlightPoints: {
            type: 'array',
            title: 'Highlight Bullet Points',
            items: { type: 'string' },
        },
        successTitle: { type: 'string', title: 'Success Title' },
        successMessage: { type: 'string', title: 'Success Message', format: 'textarea' },
        showServices: { type: 'boolean', title: 'Show Service Selector' },
        showDatePicker: { type: 'boolean', title: 'Show Date & Time Inputs' },
    },
};
...
const THEMES = [
    {
        ...
        schemaJsonb: {
            type: 'object',
            properties: {
                logoUrl: { type: 'string', title: 'Logo', format: 'image' },
    ...
    },
    {
        ...
        schemaJsonb: {
            ...
            properties: {
                ...
                imageUrl: { type: 'string', title: 'Side Image', format: 'image' },
    ...
    {
        featureSlug: 'hero',
        name: 'Aurora Motion Hero',
        slug: 'hero',
        version: 3,
        componentKey: 'hero/v3',
        schemaJsonb: {
            type: 'object',
            properties: {
                eyebrow: { type: 'string', title: 'Eyebrow Label' },
                titleLead: { type: 'string', title: 'Headline Prefix' },
                rotatingWords: { type: 'array', title: 'Rotating Headline Words', items: { type: 'string' } },
                subtitle: { type: 'string', title: 'Subtitle', format: 'textarea' },
                ctaTextPrimary: { type: 'string', title: 'Primary Button Text' },
                ctaLinkPrimary: { type: 'string', title: 'Primary Button Link', format: 'page-link' },
                ctaTextSecondary: { type: 'string', title: 'Secondary Button Text' },
                ctaLinkSecondary: { type: 'string', title: 'Secondary Button Link', format: 'page-link' },
                trustLabel: { type: 'string', title: 'Trust Label' },
                trustItems: { type: 'array', title: 'Trust Chips', items: { type: 'string' } },
                showcaseTitle: { type: 'string', title: 'Showcase Card Title' },
                showcaseBullets: { type: 'array', title: 'Showcase Bullets', items: { type: 'string' } },
            },
            required: ['titleLead'],
        },
        defaultStylesJsonb: { padding: 'large', textAlign: 'left', showOrbs: true, glassCard: true },
    },
    {
        featureSlug: 'about',
        name: 'About Section',
        ...
        schemaJsonb: {
            ...
            properties: {
                ...
                imageUrl: { type: 'string', title: 'Image', format: 'image' },
                imageAlt: { type: 'string', title: 'Image Alt Text' },
    ...
    },
    {
        ...
        schemaJsonb: {
            ...
            properties: {
                ...
                title: { type: 'string', title: 'Title' },
                body: { type: 'string', title: 'Body Text', format: 'textarea' },
                highlights: { type: 'array', title: 'Highlight Chips', items: { type: 'string' } },
                quoteText: { type: 'string', title: 'Quote', format: 'textarea' },
                quoteAuthor: { type: 'string', title: 'Quote Author' },
                ctaText: { type: 'string', title: 'Button Text (Optional)' },
                ctaLink: { type: 'string', title: 'Button Link', format: 'page-link' },
                storyPoints: {
                    type: 'array', title: 'Timeline Points',
                    items: {
                        type: 'object',
                        properties: {
                            year: { type: 'string', title: 'Year (Optional)' },
                            title: { type: 'string', title: 'Point Title' },
                            description: { type: 'string', title: 'Point Description', format: 'textarea' },
                        },
                        required: ['title'],
                    },
                },
        ...
        defaultStylesJsonb: { backgroundMode: 'soft', cardStyle: 'glass', padding: 'large' },
    },
    {
    ...
    {
        featureSlug: 'services',
        name: 'Services Spotlight',
        slug: 'services',
        version: 2,
        componentKey: 'services/v2',
        schemaJsonb: {
            type: 'object',
            properties: {
                title: { type: 'string', title: 'Section Title' },
                ...
                showSelectButton: { type: 'boolean', title: 'Show Select Service Button' },
                selectButtonText: { type: 'string', title: 'Select Button Text' },
                spotlightTitle: { type: 'string', title: 'Spotlight Label' },
                emptyTitle: { type: 'string', title: 'Empty State Title' },
                emptyDescription: { type: 'string', title: 'Empty State Description' },
            },
            required: ['title'],
        },
        defaultStylesJsonb: { showPrice: true, showDuration: true, autoRotate: true, padding: 'large' },
    },
    {
        featureSlug: 'gallery',
        name: 'Image Gallery',
            ...
            properties: {
                ...
                images: {
                    ...
                    items: {
                        type: 'object',
                        properties: {
                            url: { type: 'string', title: 'Image', format: 'image' },
                ...
                testimonials: {
                    ...
                    items: {
                        ...
                        properties: {
                            ...
                            avatarUrl: { type: 'string', title: 'Avatar', format: 'image' },
    ...
    },
    {
        ...
        accessRank: 8,
        schemaJsonb: BOOKING_WIDGET_SCHEMA,
        defaultStylesJsonb: { layout: 'inline', variant: 'classic', showServices: true, showDatePicker: true },
    },
    {
        featureSlug: 'pricing',
        name: 'Pricing Plans',
                ...
                members: {
                    ...
                    items: {
                        ...
                        properties: {
                            ...
                            photoUrl: { type: 'string', title: 'Photo', format: 'image' },
                        },
                        required: ['name', 'role'],
                    },
                },
    ...
    {
        featureSlug: 'team',
        name: 'Team Showcase Motion',
        slug: 'team',
        version: 2,
        componentKey: 'team/v2',
        schemaJsonb: {
            type: 'object',
            properties: {
                title: { type: 'string', title: 'Section Title' },
        ...
        defaultStylesJsonb: { layout: 'grid', showBio: true, padding: 'large', cardAnimation: 'lift' },
    },
    {
        featureSlug: 'booking-widget',
        name: 'Booking Widget Split',
        slug: 'booking-widget',
        version: 2,
        componentKey: 'booking-widget/v2',
        accessRank: 9,
        schemaJsonb: BOOKING_WIDGET_SCHEMA,
        defaultStylesJsonb: { layout: 'split', variant: 'split', showServices: true, showDatePicker: true },
    },
    {
        featureSlug: 'booking-widget',
        name: 'Booking Widget Compact',
        slug: 'booking-widget',
        version: 3,
        componentKey: 'booking-widget/v3',
        accessRank: 10,
        schemaJsonb: BOOKING_WIDGET_SCHEMA,
        defaultStylesJsonb: { layout: 'compact', variant: 'compact', showServices: true, showDatePicker: false },
    },
];
...
const PAGE_TEMPLATES = [
    ...
    {
        name: 'Animated Conversion Homepage',
        description: 'Motion-forward layout with animated hero and spotlight services for higher engagement.',
        previewImageUrl: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=600&h=400',
        sectionsJsonb: [
            { themeComponentKey: 'header/v1', defaultContent: { logoUrl: '', menu: [{ label: 'Home', href: '/' }, { label: 'Services', href: '/services' }, { label: 'Contact', href: '/contact' }] }, defaultStyles: {} },
            {
                themeComponentKey: 'hero/v3',
                defaultContent: {
                    eyebrow: 'Performance-first website templates',
                    titleLead: 'Grow bookings with',
                    rotatingWords: ['animation', 'clarity', 'speed'],
                    subtitle: 'A polished hero with live motion cues, clean typography, and conversion-ready CTA structure.',
                    ctaTextPrimary: 'Create My Site',
                    ctaLinkPrimary: '/booking',
                    ctaTextSecondary: 'Explore Features',
                    ctaLinkSecondary: '/services',
                    trustLabel: 'Built for business owners',
                    trustItems: ['No coding required', 'Fast load experience', 'Ready for mobile'],
                    showcaseTitle: 'Designed for action',
                    showcaseBullets: [
                        'Animated headline rotation to keep attention',
                        'Token-based color system for brand consistency',
                        'CTA pairing for primary and secondary actions',
                    ],
                },
                defaultStyles: { padding: 'large', textAlign: 'left', showOrbs: true, glassCard: true },
            },
            { themeComponentKey: 'about/v2', defaultContent: { title: 'Why clients stay with us', body: 'We blend strategy, service quality, and automation to create repeat bookings and better customer experiences.' }, defaultStyles: {} },
            {
                themeComponentKey: 'services/v2',
                defaultContent: {
                    title: 'Most Requested Services',
                    subtitle: 'Interactive spotlight cards with auto-rotation and one-click service selection.',
                    spotlightTitle: 'Today\'s Highlight',
                    showAllServices: false,
                    featuredCount: 4,
                    showSelectButton: true,
                    selectButtonText: 'Book This Service',
                },
                defaultStyles: { showPrice: true, showDuration: true, autoRotate: true, padding: 'large' },
            },
            { themeComponentKey: 'booking-widget/v3', defaultContent: { title: 'Reserve Your Slot' }, defaultStyles: {} },
            { themeComponentKey: 'testimonials/v1', defaultContent: { title: 'Loved by our clients' }, defaultStyles: {} },
            { themeComponentKey: 'footer/v1', defaultContent: { copyrightText: '© 2026 Your Business. All rights reserved.' }, defaultStyles: {} }
        ],
        isActive: true,
    },
    {
        name: 'Team Showcase Homepage',
        description: 'Balanced homepage focused on leadership credibility with animated team presentation.',
        previewImageUrl: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&q=80&w=600&h=400',
        sectionsJsonb: [
            { themeComponentKey: 'header/v1', defaultContent: { logoUrl: '', menu: [{ label: 'Home', href: '/' }, { label: 'Team', href: '/team' }, { label: 'Contact', href: '/contact' }] }, defaultStyles: {} },
            { themeComponentKey: 'hero/v2', defaultContent: { title: 'A team you can trust', subtitle: 'Strategy, craft, and reliable delivery from specialists who care about outcomes.', ctaTextPrimary: 'Start a Project', ctaLinkPrimary: '/booking', ctaTextSecondary: 'Meet The Team', ctaLinkSecondary: '/team' }, defaultStyles: { layout: 'image-right', padding: 'large' } },
            { themeComponentKey: 'about/v2', defaultContent: { title: 'People-first execution', body: 'Every engagement is backed by experienced operators, consistent communication, and transparent collaboration.' }, defaultStyles: {} },
            {
                themeComponentKey: 'team/v2',
                defaultContent: {
                    title: 'Leadership & Specialists',
                    subtitle: 'A multidisciplinary team built for high-quality service and fast response.',
                    members: [
                        { name: 'Maya Wilson', role: 'Founder', bio: 'Leads customer strategy and quality standards.' },
                        { name: 'Daniel Reed', role: 'Operations Lead', bio: 'Owns service consistency and delivery operations.' },
                        { name: 'Sofia Chen', role: 'Senior Specialist', bio: 'Delivers premium client outcomes and mentoring.' },
                        { name: 'Noah Patel', role: 'Client Success', bio: 'Coordinates communication and follow-through.' },
                    ],
                },
                defaultStyles: { layout: 'grid', showBio: true, padding: 'large', cardAnimation: 'lift' },
            },
            { themeComponentKey: 'testimonials/v1', defaultContent: { title: 'What clients say' }, defaultStyles: {} },
            { themeComponentKey: 'contact/v1', defaultContent: { title: 'Talk to our team' }, defaultStyles: {} },
            { themeComponentKey: 'footer/v1', defaultContent: { copyrightText: '© 2026 Your Business. All rights reserved.' }, defaultStyles: {} }
        ],
        isActive: true,
    },
...
async function main() {
    ...
    for (const [index, theme] of THEMES.entries()) {
        ...
        const accessRank = theme.accessRank ?? (index + 1);
