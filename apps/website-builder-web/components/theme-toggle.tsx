    ...
    return (
        <div ref={wrapperRef} className={`relative ${className}`}>
            <button
                ...
                className={`flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-left transition-colors hover:border-[#5048e5]/30 hover:bg-[#5048e5]/5 dark:border-slate-700 dark:bg-slate-800/70 ${fullWidth ? 'w-full' : ''}`}
                    ...
                    {THEME_OPTIONS.map((option) => {
                        ...
                        return (
                            <button
                                ...
                                className={`flex w-full items-center gap-2 px-3 py-2 text-left transition-colors hover:bg-[#5048e5]/5 ${selected ? 'bg-[#5048e5]/10' : ''}`}
                            >
                                ...
                                {selected && <Check size={14} className="shrink-0 text-[#5048e5]" />}
                            </button>
                        );
                    })}
                </div>
