    ...
    if (!currentInstance) {
        return (
            <div className="be-card flex min-h-[320px] items-center justify-center p-6 text-center">
                <div>
                    <Settings2 className="mx-auto mb-3 h-8 w-8 text-[#5048e5]" />
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                    <div className="mb-2 inline-flex items-center gap-2 rounded-full border border-[#5048e5]/15 bg-[#5048e5]/5 px-3 py-1 text-xs font-semibold text-[#5048e5]">
                ...
                <section className="be-card overflow-hidden">
                    <div className="border-b border-slate-200 px-5 py-4 dark:border-slate-700">
                        <div className="flex items-center gap-2">
                            <Code2 className="h-5 w-5 text-[#5048e5]" />
                        ...
                        <div className="space-y-5 p-5">
                            {CODE_FIELDS.map((field) => (
                                <div key={field.key}>
                                    ...
                                    <textarea
                                        ...
                                        className="min-h-[132px] w-full resize-y rounded-lg border border-slate-200 bg-white px-3 py-2 font-mono text-sm leading-6 text-slate-900 outline-none transition focus:border-[#5048e5] focus:ring-2 focus:ring-[#5048e5]/20 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100"
                                    />
                            ...
                            <div className="flex flex-wrap justify-end gap-3 border-t border-slate-200 pt-5 dark:border-slate-700">
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center gap-2 rounded-lg bg-[#5048e5] px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-[#5048e5]/25 transition hover:bg-[#433bcf] disabled:cursor-not-allowed disabled:opacity-60"
                                >
