                            ...
                            <div key={row.label} className="rounded-lg border border-slate-200 p-4 dark:border-slate-700">
                                ...
                                {row.limit !== null && row.limit > 0 && (
                                    <div className="mt-2 h-2 overflow-hidden rounded bg-slate-200 dark:bg-slate-700">
                                        <div className="h-full rounded bg-[#dc2626]" style={{ width: `${ratio}%` }} />
                                    </div>
                                )}
                            </div>
                        );
                    ...
                    {!canManageBilling ? (
                        ...
                        <div className="mt-4 space-y-3">
                            ...
                            <textarea
                                ...
                                className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm outline-none focus:border-[#dc2626] focus:ring-2 focus:ring-[#dc2626]/20 dark:border-slate-700 dark:bg-slate-950"
                            />
                            <button
                                type="button"
                        ...
                        {!canManageBilling ? (
                            ...
                            <div className="mt-4 flex items-center gap-3">
                                <input
                                    ...
                                    className="w-28 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm outline-none focus:border-[#dc2626] focus:ring-2 focus:ring-[#dc2626]/20 dark:border-slate-700 dark:bg-slate-950"
                                />
                                <button
                                    type="button"
