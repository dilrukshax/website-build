...
const SOURCE_CONFIGS: Record<RuntimeLogSource, RuntimeLogSourceConfig> = {
    frontend: {
        ...
        relativeCandidates: [
            'apps/website-builder-web/combined.log',
            'apps/website-builder-web/frontend.log',
            'apps/website-builder-web/dev.log',
            'cms.log',
            'frontend.log',
        ],
        unavailableNote: 'Frontend log file was not found. Start CMS with `pnpm --filter @project-aurora/website-builder-web dev:logs` to capture logs.',
    },
    backend: {
        source: 'backend',
        label: 'Backend (API)',
        ...
        relativeCandidates: [
            'combined.log',
            'apps/website-builder-api/combined.log',
            'packages/api/combined.log',
            'apps/website-builder-api/error.log',
            'error.log',
        ],
