            ...
            <div className="relative flex min-h-screen w-full flex-col">
                <header className="sticky top-0 z-50 flex items-center justify-between border-b border-slate-200 bg-white/80 px-6 py-4 backdrop-blur-md md:px-20 dark:border-slate-800 dark:bg-[#121121]/80">
                    <div className="flex items-center gap-2 text-[#5048e5]">
                        <h2 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white">buildmyonlineweb</h2>
                    </div>
                        ...
                        <div className="flex flex-col gap-8">
                            <div className="flex flex-col gap-4">
                                ...
                                <p className="max-w-xl text-lg font-normal leading-relaxed text-slate-600 md:text-xl dark:text-slate-400">
                                    buildmyonlineweb now enforces each plan directly in API and CMS: usage caps, add-on bundles, manual charge approval, point wallet credits, and fraud-proof referral claims.
                                </p>
                            </div>
                ...
                <footer className="border-t border-slate-200 bg-white px-6 py-12 md:px-20 dark:border-slate-800 dark:bg-[#121121]">
                    <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-8 md:flex-row">
                        <div className="flex items-center gap-2 text-[#5048e5]">
                            <h2 className="text-lg font-bold leading-tight text-slate-900 dark:text-white">buildmyonlineweb</h2>
                        </div>
                        ...
                        <p className="text-sm text-slate-400">© {new Date().getFullYear()} buildmyonlineweb. All rights reserved.</p>
                    </div>
                </footer>
            </div>
        </div>
