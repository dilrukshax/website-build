                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-4">
                    ...
                    <label className="flex items-center gap-2 rounded-lg border border-slate-200 px-3 py-2 text-sm font-medium text-slate-700 dark:border-slate-700 dark:text-slate-200">
                        <input
                            ...
                            className="h-4 w-4 rounded border-slate-300 text-[#5048e5] focus:ring-[#5048e5]/30 dark:border-slate-600"
                        />
                        Auto refresh (5s)
                    </label>
                    ...
                    <button
                        ...
                        className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#5048e5] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#433bcf] disabled:cursor-not-allowed disabled:opacity-60"
                    >
                                ...
                                <div className="flex flex-wrap items-start justify-between gap-3">
                                    <div>
                                        <div className="flex items-center gap-2">
                                            <TerminalSquare className="h-5 w-5 text-[#5048e5]" />
